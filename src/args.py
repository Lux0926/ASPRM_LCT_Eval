...
def get_args(parser):
    ...
    parser.add_argument("--task", default="HumanEval", type=str, choices=["HumanEval", "MBPP", "LeetCode", "BigCodeHard", "BigCodeBench", "HumanEvalPlus", "MBPPPlus", "MBPPBase", "LeetCodeTest","LeetCodeTrain"])
    ...
    parser.add_argument("--eval_type", default = "", type=str)
    parser.add_argument("--pass_size", default = 1, type=int)
